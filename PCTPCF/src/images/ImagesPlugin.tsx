...
export default function (): React.JSX.Element | null {
  ...
  useEffect(() => {
    ...
    return mergeRegister(
      editor.registerCommand<InsertImagePayload>(
        ...
        (payload) => {
          if(payload.src.length > 2_000_000){
            notification.error({
              message: <Trans>imageTooLarge</Trans>,
              description: <Trans>imageTooLargeDescription</Trans>,
            })
            return true; //what is this? should i return false?
          }
